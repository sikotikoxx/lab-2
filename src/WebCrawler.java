...
public class WebCrawler{
    ...
    public boolean esXHTMLValido(String xhtml) {
        ...
        if (!xhtml.toUpperCase().contains("<!DOCTYPE")) {
            return false;
        }
        ...
        if (!etiquetaHtml.contains("xmlns")) {
            return false;
        }
        ...
        while (matcher.find()) {
            ...
            if (!nombreEtiqueta.equals(nombreEtiqueta.toLowerCase())) {
                return false;
            }
            if (atributos.trim().endsWith("/")) {
                continue;
            }
            if (esCierre.equals("")) {
